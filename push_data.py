# this file is basically for pushing the data on mongodb atlas
import os
import sys
import json
...
"""When Python connects to a server over HTTPS or TLS/SSL, 
it needs to make sure the server is really who it claims to be.
